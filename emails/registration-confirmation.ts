        ...
        <div style="background-color:#1E293B;border-radius:12px;padding:24px;margin:28px 0;border:1px solid rgba(255,255,255,0.08);">
          ...
          <table style="width:100%;border-collapse:collapse;font-size:14px;">
            ...
            <tr>
              ...
              <td style="padding:10px 0;border-bottom:1px solid rgba(255,255,255,0.08);text-align:right;font-weight:700;color:#FFFFFF;">${cohortLabel || "2-Week Evening Class"}</td>
            </tr>
            <tr>
